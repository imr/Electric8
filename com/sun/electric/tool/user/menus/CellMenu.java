...
public class CellMenu {
	...
	{
		CellProperties dialog = new CellProperties(Main.getCurrentJFrame());
	...
	{
		NewCell dialog = new NewCell(Main.getCurrentJFrame());
		dialog.setVisible(true);
	}

	public static void cellBrowserCommand(CellBrowser.DoAction action)
	{
		CellBrowser dialog = new CellBrowser(Main.getCurrentJFrame(), false, action);
		dialog.setVisible(true);
	}
	...
	{
		CrossLibCopy dialog = new CrossLibCopy(Main.getCurrentJFrame());
		dialog.setVisible(true);
	}
