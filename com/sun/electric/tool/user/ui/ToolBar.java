...
public class ToolBar extends JToolBar
{
	...
	public static void setToolbarButtons(EToolBarButton[] buttons)
	{
		...
		for(Iterator<WindowFrame> it = WindowFrame.getWindows(); it.hasNext(); )
		{
			...
			ToolBar tb = ((Main) wf.getFrame()).getToolBar();
			tb.redoToolbar();
		}
	}
	...
	private static void rewriteGridDistance()
	{
		...
		if (Main.toolBar != null)
			Main.toolBar.currentGridAmount.setText(valStr);
		//for(Iterator<WindowFrame> it = WindowFrame.getWindows(); it.hasNext(); ) TODO add back in for SDI
		//{
		//	WindowFrame wf = it.next();
		//	ToolBar tb = ((Main) wf.getFrame()).getToolBar();
